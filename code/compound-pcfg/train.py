...
=======
##EP : adding flag for device type
parser.add_argument('--device_type', default='cpu', help='specify if using cpu or gpu device')
>>>>>>> e0e70216b22e2b5fc75f5ac1349e6b556270c66a
# Model options
