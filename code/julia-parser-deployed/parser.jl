...
<{n}(a::ModInt{n}, b::ModInt{n}) where n = a.val < b.val

one{n}(a::ModInt{n}) where n = ModInt{n}(1)
zero{n}(a::ModInt{n}) where n = ModInt{n}(0)

convert{n}(::Type{ModInt{n}}, x::Int) where n = ModInt{n}(x)
convert(::Type{Int}, x::ModInt) = x.val

getindex(t::Union{Tuple, Array}, i::ModInt) = getindex(t, i.val + 1)

promote_rule{n}(::Type{ModInt{n}}, ::Type{Int}) where n = ModInt{n}
